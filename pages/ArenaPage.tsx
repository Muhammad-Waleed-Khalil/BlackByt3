        ...
        <div className="relative bg-black border border-gray-700 p-8 md:p-12 mb-16">
           ...
           <div className="relative z-10 flex flex-col lg:flex-row gap-12">
             <div className="flex-1">
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 {ARENA_CONTENT.features.map((feat, i) => (
                   <div key={i} className="bg-gray-900/30 p-3 border-l-2 border-red-900 text-sm font-mono text-gray-300 hover:text-white hover:border-red-500 transition-colors">
                     {feat}
                   </div>
                 ))}
               </div>
             ...
             <div className="w-full lg:w-80 bg-black border border-red-600/30 p-6 flex flex-col items-center justify-center text-center shadow-[0_0_20px_rgba(255,0,0,0.1)]">
               ...
               <div className="text-xs text-gray-400 font-mono uppercase mb-6">Time Remaining</div>
              ...
              <div key={idx} className="bg-black/60 border border-gray-700 p-6 hover:border-red-600 transition-colors">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-gray-300 font-mono text-sm">{event.type}</p>
                  </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="text-gray-300 font-mono">{event.location}</span>
                  </div>
                  <div>
                    <span className="text-red-900 font-mono uppercase block mb-1">Participants</span>
                    <span className="text-gray-300 font-mono">{event.participants}</span>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {teamMembers.map((member, idx) => (
              <div key={idx} className="bg-black/60 border border-gray-700 p-4 text-center">
