    ...
    return (
      <div className="min-h-screen py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="bg-black/80 p-8 border border-gray-800 space-y-6">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="bg-black/60 border border-gray-800 p-6 text-center">
            ...
            <p className="text-gray-400 font-mono text-sm">Collaborate with top-tier security professionals and industry leaders.</p>
          </div>
          <div className="bg-black/60 border border-gray-800 p-6 text-center">
            ...
            <p className="text-gray-400 font-mono text-sm">Remote-first culture with flexible hours and work-life balance.</p>
          </div>
          <div className="bg-black/60 border border-gray-800 p-6 text-center">
            ...
            <p className="text-gray-400 font-mono text-sm">Industry-leading compensation, benefits, and professional development.</p>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="space-y-6">
            {jobOpenings.map((job) => (
              <div key={job.id} className="bg-black/60 border border-gray-800 p-6 hover:border-red-600 transition-colors">
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-4">
                  <div className="mb-4 lg:mb-0">
                    <h4 className="text-xl font-['Unica_One'] text-white mb-2">{job.title}</h4>
                    <p className="text-gray-400 font-mono text-sm">{job.description}</p>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <span className="text-xs font-mono border border-red-900/30 px-2 py-1 text-gray-500 uppercase">
                      {job.department}
                    </span>
                    <span className="text-xs font-mono border border-red-900/30 px-2 py-1 text-gray-500 uppercase">
                      {job.type}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-gray-400">{job.location}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Clock className="w-4 h-4 text-red-600" />
                    <span className="font-mono text-gray-400">{job.experience}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <DollarSign className="w-4 h-4 text-red-600" />
                    <span className="font-mono text-gray-400">{job.salary}</span>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-1">
                    {job.requirements.map((req, idx) => (
                      <li key={idx} className="text-gray-400 font-mono text-xs flex items-center gap-2">
