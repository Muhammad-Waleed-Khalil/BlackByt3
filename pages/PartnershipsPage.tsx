        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {strategicPartners.map((partner, idx) => (
              <div key={idx} className="bg-black/60 border border-gray-800 p-6 hover:border-red-600 transition-colors group">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="text-xs font-mono border border-red-900/30 px-2 py-1 text-gray-500 uppercase bg-black/50">
                    {partner.status}
                  </span>
                </div>
