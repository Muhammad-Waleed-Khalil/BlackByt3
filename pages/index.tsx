  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden bg-black">
      ...
      <section className="py-20 px-4 border-t border-black relative">
        <div className="absolute inset-0 bg-cover bg-center lg:hidden" style={{ backgroundImage: 'url(/whyblackbyt3.webp)' }}></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="hidden lg:block w-96 flex-shrink-0">
              <img src="/whyblackbyt3.webp" alt="Why Black Byt3" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
